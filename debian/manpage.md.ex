% gz-common(SECTION) | User Commands
%
% "March  8 2023"
...
gz-common - program to do something

# SYNOPSIS

**gz-common** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**gz-common** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **gz-common** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**gz-common** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    gz-common. See **foo.conf**(5) for further details.
...
**gz-common** provides some return codes, that can be used in scripts:
...
Giovanni Senatore <giovanni.senatore@gmail.com>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 Giovanni Senatore
